...
_target_: {{cookiecutter.project_slug}}.models.MyModel  # CHANGE_ME
...
_target_: {{cookiecutter.project_slug}}.models.ResNet50
...
```bash
python -m src.{{cookiecutter.project_slug}}.core.train model=resnet50
```

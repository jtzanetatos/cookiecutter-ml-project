...
python -m src.{{cookiecutter.project_slug}}.core.train data=base

# Override dataset path
python -m src.{{cookiecutter.project_slug}}.core.train data.path=${paths.data_dir}/processed/v2

# Switch to another dataset variant
python -m src.{{cookiecutter.project_slug}}.core.train data=imagenet
```

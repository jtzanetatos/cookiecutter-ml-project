...
python -m src.{{cookiecutter.project_slug}}.core.train model=conv_autoencoder data=base trainer=base

# Override individual parameters
python -m src.{{cookiecutter.project_slug}}.core.train trainer.max_epochs=20 model.lr=1e-4

# Use a named experiment preset (if defined)
python -m src.{{cookiecutter.project_slug}}.core.train experiment=baseline
```

...
python -m src.{{cookiecutter.project_slug}}.core.train mlflow.enabled=false

# LOCAL DEBUG ONLY: override tracking server
python -m src.{{cookiecutter.project_slug}}.core.train mlflow.tracking_uri=http://127.0.0.1:5000
```

...
# Quick dev run
python -m src.{{cookiecutter.project_slug}}.core.train trainer=fast_dev

# Override runtime parameters
python -m src.{{cookiecutter.project_slug}}.core.train trainer.max_epochs=50 trainer.precision=16
```

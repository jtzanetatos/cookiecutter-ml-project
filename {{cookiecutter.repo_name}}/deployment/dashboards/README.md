...
They should import:
- inference logic from `src/<{{cookiecutter.project_slug}}>/inference/`
- schemas from `src/<{{cookiecutter.project_slug}}>/schemas/`
- tool integrations from `src/<{{cookiecutter.project_slug}}>/integrations/`
